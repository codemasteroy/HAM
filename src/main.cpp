...
// Copyright (c) 2013 HamRadioCoin developers
...
const string strMessageMagic = "HamRadioCoin Signed Message:\n";
...
static const int64 nTargetSpacing = 180; //3 minute block spacing targets
static const int64 nInterval = nTargetTimespan / nTargetSpacing; // 10 blocks

static const int64 nAveragingInterval = nInterval * 5; // 50 blocks
static const int64 nAveragingTargetTimespan = nAveragingInterval * nTargetSpacing; // 40 minutes

static const int64 nMaxAdjustDown = 15; // 20% adjustment down
static const int64 nMaxAdjustUp = 15; // 10% adjustment up
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("HamRadioCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("HamRadioCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("HamRadioCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running HamRadioCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("HamRadioCoinMiner terminated\n");
        throw;
    }
}
